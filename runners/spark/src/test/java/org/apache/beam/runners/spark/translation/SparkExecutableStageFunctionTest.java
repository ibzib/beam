...
public class SparkExecutableStageFunctionTest {
              ...
              Components.newBuilder()
                  .putTransforms(
                      ...
                      RunnerApi.PTransform.newBuilder()
                          .putInputs("input-name", INPUT_ID)
                          .setSpec(RunnerApi.FunctionSpec.newBuilder().setUrn(PAR_DO_TRANSFORM_URN))
                          .build())
                  .putPcollections(INPUT_ID, PCollection.getDefaultInstance())
                  .build())
          .build();
  ...
  public void sdkErrorsSurfaceOnClose() throws Exception {
    SparkExecutableStageFunction<Integer, Integer> function = getFunction(Collections.emptyMap());
  ...
  public void expectedInputsAreSent() throws Exception {
    ...
    when(bundle.getInputReceivers()).thenReturn(ImmutableMap.of(INPUT_ID, receiver));
  ...
  public void outputsAreTaggedCorrectly() throws Exception {
    ...
    SparkExecutableStageFunction<Integer, Integer> function = getFunction(outputTagMap);
